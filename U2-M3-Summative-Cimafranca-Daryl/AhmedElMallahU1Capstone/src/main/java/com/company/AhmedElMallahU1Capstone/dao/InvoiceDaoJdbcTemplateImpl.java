...
public class InvoiceDaoJdbcTemplateImpl implements InvoiceDao {
    ...
    public Invoice addInvoice(Invoice invoice) {
        jdbcTemplate.update(INSERT_INVOICE_SQL,
                invoice.getName(), invoice.getStreet(), invoice.getCity(), invoice.getState(), invoice.getZipcode(),
                invoice.getItemType(),invoice.getItemId(),invoice.getUnitPrice(),invoice.getQuantity(),
                invoice.getSubtotal(),invoice.getTax(),invoice.getProcessingFee(),invoice.getTotal());
    ...
    public Invoice getInvoice(int id) {
        try {
            ...
            throw new NullPointerException("Invoice id doesn't exist.");
        }
    }
